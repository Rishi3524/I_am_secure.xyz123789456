...
const char *new_strong_password = "NewStrongP@ss456";
...
int main(int argc, char *argv[]) {
 ...
 // Test logging functionality
  ...
  bool updated = account_update_password(acc, new_strong_password);
  ...
  login_result_t login_result = handle_login("testuser", new_strong_password, 
                                           test_ip, now,
